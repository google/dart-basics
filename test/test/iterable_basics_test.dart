...
void main() {
  ...
  group('max', () {
    ...
    test('returns absent optional for empty iterable', () {
      final emptyInts = <int>[];
      final emptyStrings = <String>{};

      expect(emptyInts.max().isPresent, isFalse);
      expect(emptyInts.max((a, b) => a.compareTo(b)).isPresent, isFalse);
      expect(
        emptyStrings.max((a, b) => a.length.compareTo(b.length)).isPresent,
        isFalse,
      );
    });
  });
  ...
  group('max on Iterable of nums', () {
    test('returns largest int', () {
      ...
      expect(nums.max().value, equals(3));
    });

    test('returns largest double', () {
      final nums = <double>[1.0, 2.0, 3.0];

      expect(nums.max().value, equals(3.0));
    });
    ...
    test('returns smallest double with custom comparator', () {
      ...
      expect(nums.max((a, b) => b.compareTo(a)).value, equals(1.0));
    });
  });
  ...
  group('min', () {
    test('works with custom comparator', () {
      ...
      expect(
        strings.min((a, b) => a.length.compareTo(b.length)).value,
        equals('a'),
      );
    });
    ...
    test('returns absent optional for empty iterable', () {
      ...
      expect(emptyInts.min().isPresent, isFalse);
      expect(emptyInts.min((a, b) => a.compareTo(b)).isPresent, isFalse);
      expect(
        emptyStrings.min((a, b) => a.length.compareTo(b.length)).isPresent,
        isFalse,
      );
    });
  });
  ...
  group('min on Iterable of nums', () {
    test('returns smallest int', () {
      ...
      expect(nums.min().value, equals(1));
    });

    test('returns smallest double', () {
      final nums = <double>[1.0, 2.0, 3.0];

      expect(nums.min().value, equals(1.0));
    });
    ...
    test('returns largest double with custom comparator', () {
      ...
      expect(nums.min((a, b) => b.compareTo(a)).value, equals(3.0));
    });
  });
  ...
  group('maxBy', () {
    test('returns the max value according to provided sort key', () {
      final list = [3, 222, 11];
      expect(list.maxBy((e) => e.toString().length).value, 222);
      expect(list.maxBy((e) => e.toString()).value, 3);
    });

    test('works on sets', () {
      final values = {3, 222, 11};
      expect(values.maxBy((e) => e.toString().length).value, 222);
      expect(values.maxBy((e) => e.toString()).value, 3);
    });
    ...
    test('returns absent optional for empty iterable', () {
      ...
      expect(emptyInts.maxBy((a) => a.toString().length).isPresent, isFalse);
      expect(emptyStrings.maxBy((a) => a.length).isPresent, isFalse);
    });
  });
  ...
  group('minBy', () {
    test('returns the min value according to provided sort key', () {
      final list = [3, 222, 11];
      expect(list.minBy((e) => e.toString().length).value, 3);
      expect(list.minBy((e) => e.toString()).value, 11);
    });

    test('works on sets', () {
      final values = {3, 222, 11};
      expect(values.minBy((e) => e.toString().length).value, 3);
      expect(values.minBy((e) => e.toString()).value, 11);
    });
    ...
    test('returns absent optional for empty iterable', () {
      ...
      expect(emptyInts.minBy((a) => a.toString().length).isPresent, isFalse);
      expect(emptyStrings.minBy((a) => a.length).isPresent, isFalse);
    });
  });
